...
def countNode(update, context):
    ...
    if is_gdrive_link(link):
        msg = sendMessage(f"Please Wait.. I'm Counting: <code>{link}</code>", context.bot, update.message)
        ...
        sendMessage('Hey! Wait You need to Send me Gdrive link along with command.', context.bot, update.message)
